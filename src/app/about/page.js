      ...
      <div className="about">
        <div className="about_content">
          ...
          <div className="about_text">
            ...
            <div>
              At 3T, we craft not just visually stunning but also flavor-packed
              sweet treats. We offer a range of desserts, from custom birthday
              cakes to delectable and enticing cupcakes. Each treat is handmade
              with dedication and special care to ensure the highest quality.{" "}
            </div>
          </div>
          <div className="about_text">
            <div className="text-4xl font-extrabold ...">
            ...
            <div>
              ...
              creating memorable experiences. We're passionate about sharing the
              joy of crafting delicious and unique sweet treats with everyone.
              Each creation is a work of art, and our mission is to bring joy
              and happiness to every customer through our exquisite offerings.
            </div>
          </div>
        </div>
